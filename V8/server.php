...
if (isset($_POST['reg_tool'])) {
    ...
    if (count($errors) == 0) {
        ...
        $tool_query = "INSERT INTO tool_registry (owner_id, tool, additional_items, description, availability, comments) 
            VALUES('$user_id', '$tool', '$additional_items', '$description', '$availability', '$comments')";
