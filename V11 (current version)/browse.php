            ...
            if (isset($_POST['search'])) {
                ...
                if ($tool_request == "" && 
                        $location_request == "") {
                            ...
                            echo "<div class='search-error'><br><br>
                                please serch for a tool</div>";
                }
                else {
                    ...
                    $tool_qry = "SELECT 
                        ...
                        ON tr.owner_id = r.id WHERE region LIKE 
                        '%$location_request%' AND tool LIKE 
                        '%$tool_request%'";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<h2 class='search-error'><br><r>
                            Apologies but no matches 
                            were found</h4>";
                    }
                }
            }
